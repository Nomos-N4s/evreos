...
harness land before its first check. Three have since landed beside it — the
crate policy, the engine prohibition and the language-place separation — so
those steps now run them.
