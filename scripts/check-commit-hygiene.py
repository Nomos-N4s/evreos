...
every key ending -by or -with, not only Co-Authored-By. A legitimate Reviewed-by
or Reported-by trailer naming a human called Claude or Devin is rejected,
although CLAUDE.md bans only co-authorship trailers and Principle I expressly
permits recording that a review ran.
"""
import argparse
import re
import subprocess
